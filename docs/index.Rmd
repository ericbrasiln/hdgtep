...
author: "Apresentação para a mesa *Humanidades Digitais* no III Seminário Internacional Histórias do Pós-abolição no Mundo Atlântico.<br><br>**Eric Brasil** (IHLM/UNILAB)<br>ericbrasiln@proton.me"
date: "<br>01 de dezembro de 2022<br><br>"
encoding: "UTF-8"
logo: "https://3internacionalposabolicao.com.br/wp-content/uploads/elementor/thumbs/Logo-2-pox8u5vwl3s8qga4t5ucfm8cwyqgo3blvzj3ajhi7c.png"
output:
...
.pull-left[
```{r, out.width="100%"}
knitr::include_graphics("img/logo-gtep.png")
```
]

.pull-right[
```{r, out.width="90%"}
knitr::include_graphics("https://3internacionalposabolicao.com.br/wp-content/uploads/elementor/thumbs/Logo-2-pox8u5vwl3s8qga4t5ucfm8cwyqgo3blvzj3ajhi7c.png")
```
]
...
--
### - Computadores nas Humanidades antes das Humanidades Digitais
...
--
### -  Muitas histórias do uso do computador na historiografia
<br>
...
### [Clique aqui para ver dados](https://ericbrasiln.github.io/pibic_2020-2021/pos-abolicao/graphs/bar_tema_10_central.html) e [aqui](https://priscilavalverdes.github.io/TCC-Pos-abolicao/) para acessar a monografia completa.
<br>
...
### [Ver dados completos da pesquisa](https://github.com/Curso-de-Historia-Unilab-Males/historia-digital-PIBIC)
<br>
...
## Acesse a bibliografia utilizada na apresentação [clicando aqui](biblio.html).
<br>
